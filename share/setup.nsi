...
!define URL http://www.Kennedy.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/Kennedy.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\Kennedy-qt.exe
...
OutFile Kennedy-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/Kennedy-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/Kennedyd.exe
    ...
    #Delete /REBOOTOK $INSTDIR\Kennedy.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\Kennedy-qt.exe
