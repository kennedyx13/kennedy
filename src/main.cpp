...
const string strMessageMagic = "Kennedy Signed Message:\n";
...
// Kennedy: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Kennedy", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Kennedy";
        CTransaction txNew;
        txNew.nTime = 1506333612;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1506333612;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 648161 : 648161;
        ...
        assert(block.hashMerkleRoot == uint256("0xf088c122bd9464a46a3ff518e225e622b0472c875daa5eb818f8337ce1ca7050"));
...
unsigned char pchMessageStart[4] = { 0xf1, 0xa2, 0x35, 0xc3 };
